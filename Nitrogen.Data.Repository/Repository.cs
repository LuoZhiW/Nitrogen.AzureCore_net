...
using Nitrogen.Foundation.Util.Model;
using Nitrogen.Foundation.Util.Web;
using System;
...
namespace Nitrogen.Data.Repository
{
    ...
    public class Repository:IRepository
    {
        ...
        {
            return db.BatchInsert<T>(entity);
        }
        /// <summary>
        /// 删除实体数据
        /// </summary>
        ...
        {
            return db.BatchDelete<T>(entity);
        }
        /// <summary>
        /// 删除表数据（根据Lambda表达式）
        /// </summary>
        ...
        {
            return db.BatchUpdate<T>(entity);
        }
        #endregion
